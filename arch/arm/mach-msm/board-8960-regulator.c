...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("mipi_csi_vdd",	"msm_camera_imx111.0"),
};
VREG_CONSUMERS(L3) = {
...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam_vana",		"msm_camera_imx111.0"),
...
VREG_CONSUMERS(L12) = {
	...
	REGULATOR_SUPPLY("cam_vdig",		"msm_camera_imx111.0"),
};
VREG_CONSUMERS(L14) = {
...
VREG_CONSUMERS(L16) = {
	...
	REGULATOR_SUPPLY("cam_vaf",		"msm_camera_imx111.0"),
};
VREG_CONSUMERS(L17) = {
...
VREG_CONSUMERS(LVS5) = {
	...
	REGULATOR_SUPPLY("cam_vio",		"msm_camera_imx111.0"),
};
VREG_CONSUMERS(LVS6) = {
