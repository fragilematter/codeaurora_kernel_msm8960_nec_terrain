...
#define ECS_RST		20	/*reset */
#define ECS_INTR	18	/*INT1 */
...
extern int AKM_vib_off(void);        /* Vibrator OFF event */
extern int AKM_vib_on(void);         /* Vibrator ON event */
extern int AKM_speaker_off(void);    /* Speaker OFF event */
extern int AKM_speaker_on(void);     /* Speaker ON event */
