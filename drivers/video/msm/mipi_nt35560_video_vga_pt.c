...
static int __init mipi_video_nt35560_vga_pt_init(void)
{
	int ret;

	if(GG3_LCD_DEBUG)
		printk(KERN_ERR "[GG3_LCD]%s mipi-dsi nt35560 vga (640x480) driver ver 0.5.\n", __func__);

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_nt35560_wvga"))
		return 0;
#endif
	if (msm_fb_detect_client_ncm("mipi_video_nt35560_vga_pt"))
	{
...
module_init(mipi_video_nt35560_vga_pt_init);
