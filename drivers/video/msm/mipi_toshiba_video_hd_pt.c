...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	/* timing   */
	{ 0xA5, 0x89, 0x15, 0x00, 0x30, 0x8E, 0x19, 0x8B, 0x17, 0x03, 0x04, 0xA0 },
	/* phy ctrl */
	{ 0x5F, 0x00, 0x00, 0x10 },
	/* strength */
	{ 0xFF, 0x00, 0x06 },
	/* pll control */
	{ 0x00, 0xB0, 0x31, 0xDA, 0x00, 0x50, 0x48, /*  0- 6 */
	  0x63, 0x31, 0x0F, 0x03, 0x00, 0x14, 0x03, /*  7-13 */
	  0x00, 0x02, 0x00, 0x20, 0x00, 0x01        /* 14-20 */
	},
};

static int __init mipi_video_toshiba_hd_pt_init(void)
{
	int ret;
#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_toshiba_hd"))
		return 0;
#endif

	if (msm_fb_detect_client_ncm("mipi_video_toshiba_hd_pt"))
	{
	...
	pinfo.bl_max = 15; /* back light */
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
	/*pinfo.clk_rate = 415549440;*/ /* use frame_rate insted of */
	pinfo.clk_rate = 433000000; /* use frame_rate insted of */
...
module_init(mipi_video_toshiba_hd_pt_init);
