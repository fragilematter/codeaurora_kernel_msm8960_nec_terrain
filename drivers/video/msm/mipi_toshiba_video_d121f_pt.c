...
static int __init mipi_video_toshiba_d121f_pt_init(void)
{
	int ret;
#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_toshiba_d121f"))
		return 0;
#endif

	if (msm_fb_detect_client_ncm("mipi_video_toshiba_d121f_pt"))
	{
	...
	ret = mipi_renesas_d121f_device_register(&pinfo, MIPI_DSI_PRIM,
						MIPI_DSI_PANEL_D121F_PT);
	if (ret)
...
module_init(mipi_video_toshiba_d121f_pt_init);
