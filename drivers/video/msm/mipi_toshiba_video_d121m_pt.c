...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	/* timing   */
	{ 0xB8, 0x38, 0x20, 0x00, 0x98, 0x98,
	  0x23, 0x3A, 0x23, 0x03, 0x04, 0xA0 },
	/* phy ctrl */
	{ 0x5F, 0x00, 0x00, 0x10 },
	/* strength */
	{ 0xFF, 0x00, 0x06 },
...
static int __init mipi_video_toshiba_d121m_pt_init(void)
{
	int ret;
#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_toshiba_d121m"))
		return 0;
#endif

	if (msm_fb_detect_client_ncm("mipi_video_toshiba_d121m_pt"))
	{
	...
	ret = mipi_renesas_d121m_device_register(&pinfo, MIPI_DSI_PRIM,
						MIPI_DSI_PANEL_D121M_PT);
	if (ret)
...
module_init(mipi_video_toshiba_d121m_pt_init);
